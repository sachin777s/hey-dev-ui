...
const Sidebar = () => {
    ...
    return (
        <div
            ref={menuRef}
            className={`py-4 px-2 w-1/2 sm:w-[20%] min-w-[14rem] h-screen sm:min-h-screen bg-white dark:bg-black border-x-[0.5px] border-color flex flex-col items-start sm:items-end xl:items-start fixed top-0 transition-all duration-300 ${isNavbarOpen ? "left-0" : "-left-full"} sm:sticky shadow-xl shadow-slate-400 sm:shadow-none z-10`}
        >
